...
public class Shuffle {
	...
	private long sampleSize = 36288000;
	...
	public void run() {
		...
		while(counter < sampleSize) {
			...
			ArrayList<Integer> shuffled7 = dovetailShuffle(shuffled6);
			ArrayList<Integer> shuffled8 = dovetailShuffle(shuffled7);
			ArrayList<Integer> shuffled9 = dovetailShuffle(shuffled8);
			ArrayList<Integer> shuffled10 = dovetailShuffle(shuffled9);
			ArrayList<Integer> shuffled = dovetailShuffle(shuffled10);
